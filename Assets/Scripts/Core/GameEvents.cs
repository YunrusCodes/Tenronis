...
namespace Tenronis.Core
{
    ...
    public static event Action OnPlayExplosiveBlockDestroyedSound; // 爆炸方塊被破壞音效
    ...
    public static void TriggerPlayExplosiveBlockDestroyedSound() => OnPlayExplosiveBlockDestroyedSound?.Invoke();
