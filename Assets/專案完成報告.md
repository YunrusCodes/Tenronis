...
| 類別 | 數量 | 說明 |
|------|------|------|
| 核心系統 | 3 | GameEvents, GameInitializer |
...
1. **Defense** (裝甲強化) - 增加方塊HP
2. **Volley** (多重齊射) - 每行增加導彈數量
3. **Heal** (緊急修復) - 恢復50% HP
4. **Explosion** (過載爆破) - 溢出時對敵人造成傷害
5. **Salvo** (協同火力) - 齊射傷害加成
6. **Burst** (連發加速器) - Combo傷害加成
7. **Counter** (反擊系統) - 新方塊被擊中時反擊
8. **Execution** (戰術處決) - 清除每列底部方塊
9. **Repair** (結構修復) - 填補封閉空洞（BFS演算法）
