...
1. **Defense** (裝甲強化) - 起始0，無上限，增加方塊HP
2. **Volley** (齊射強化) - 起始1，上限6，增加多排消除時的子彈傷害
3. **Heal** (緊急修復) - 立即效果，恢復50% HP
4. **Explosion** (過載爆破) - 起始1，上限4，增加充能上限（每次+200，最多1000）
5. **Salvo** (協同火力) - 起始0，無上限，齊射傷害加成
6. **Burst** (連發強化) - 起始1，上限6，Combo傷害加成
7. **Counter** (反擊強化) - 起始1，上限6，新方塊被擊中時反擊
